...
static constexpr auto qt_meta_stringdata_ZN12ActionButtonE = QtMocHelpers::stringData(
    "ActionButton",
    "buttonPressed",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12ActionButtonE[] = {
...
Q_CONSTINIT const QMetaObject ActionButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12ActionButtonE.offsetsAndSizes,
    qt_meta_data_ZN12ActionButtonE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12ActionButtonE_t,
        // Q_OBJECT / Q_GADGET
...
void ActionButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ActionButton::*)();
            if (_q_method_type _q_method = &ActionButton::buttonPressed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ActionButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12ActionButtonE.stringdata0))
